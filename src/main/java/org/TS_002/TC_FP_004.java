...
public class TC_FP_004 {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            boolean logo = driver.findElement(By.xpath("//div[@data-bind='html: $parent.prepareMessageForHtml(message.text)']")).isDisplayed();
            Thread.sleep(1000);
            System.out.println("A success warning message is displayed.");
        }
        catch (Exception e){
            System.out.println("A success warning message did not displayed.");
        }
